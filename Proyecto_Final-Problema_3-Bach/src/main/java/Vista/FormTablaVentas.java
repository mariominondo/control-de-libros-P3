...
public class FormTablaVentas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FormTablaVentas
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTablaVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTablaVentas().setVisible(true);
            }
        });
    }
